...
car = [
    ...
    url(r'^api/v1/showCarsColor=/(?P<make>[a-zA-Z]+)/?', views.showCertainMakeCar),
    url(r'^api/v1/individualcar/(?P<car_id>[0-9]+)/?', views.individualCarData, name='carPage'),
]
...
user = [
    ...
    url(r'^api/v1/individualuser/(?P<user_id>[0-9]+)/?', views.individualUserData, name='userPage'),
]
